...
import config
from age_pop_seoul import age_rename_seoul



def get_age_pop_seoul():
    """
    정제된 데이터를 불러오는 함수
    """
    
    return age_rename_seoul()
...
def load_on(df):
    ...
    # table creation
    cur.execute("""CREATE TABLE IF NOT EXISTS age_pop_seoul(
    ...
    # insert query
    query = f'INSERT INTO age_pop_seoul({columns}) \
