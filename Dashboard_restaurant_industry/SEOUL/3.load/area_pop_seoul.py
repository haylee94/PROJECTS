...
import config
from area_pop_seoul import area_rename_seoul
...
def load_on(df):
    ...
    # table creation
    cur.execute("""CREATE TABLE IF NOT EXISTS area_pop_seoul(
    ...
    # insert query
    query = f'INSERT INTO area_pop_seoul({columns}) VALUES(%s,%s,%s,%s,%s,%s,%s)'
